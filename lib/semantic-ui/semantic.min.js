...
!function (e, t, n, i) {
    e.site = e.fn.site = function (o) {
        ...
        verbose: !1,
        performance: !0,
        modules: ["tajeraccordion", "api", "checkbox", "dimmer", "tajerdropdown", "embed", "form", "suimodal", "nag", "popup", "rating", "shape", "sidebar", "state", "sticky", "tab", "transition", "visit", "visibility"],
        siteNamespace: "site",
            ...
            F = {
                initialize: function () {
                    ...
                    f.each(function () {
                        ...
                        c && (F.verbose("Resetting error on field", i), i.removeClass(S.error), o.remove()), s ? (F.verbose("Resetting tajerdropdown value", n, a), n.tajerdropdown("clear")) : r ? t.prop("checked", !1) : (F.verbose("Resetting field value", t, a), t.val(""))
                    })
                }, reset: function () {
                    f.each(function () {
                        ...
                        r !== i && (l && (F.verbose("Resetting error on field", o), o.removeClass(S.error), a.remove()), c ? (F.verbose("Resetting tajerdropdown value", n, r), n.tajerdropdown("restore defaults")) : s ? (F.verbose("Resetting checkbox value", n, r), t.prop("checked", r)) : (F.verbose("Resetting field value", t, r), t.val(r)))
                    })
                }, is: {
                    ...
                    field: {
                        keydown: function (t) {
                            ...
                            i.hasClass(S.error) ? (F.debug("Revalidating field", n, o), F.validate.form.call(F, t, !0)) : ("blur" == x.on || "change" == x.on) && F.validate.field(o)
                        }, change: function (t) {
                    ...
                    ancillaryValue: function (e) {
                        ...
                        A = x.namespace, w = x.metadata, k = x.selector, S = x.className, T = x.error, R = "module-" + A, P = "." + A, E = D.data(R), F.refresh()
                    }, field: function (t) {
                    ...
                    success: function () {
                        ...
                        e.isEmptyObject(t) || e.each(t, function (t, n) {
                            ...
                            })) : l ? (F.verbose("Selecting radio value", n, o), o.filter('[value="' + n + '"]').parent(k.uiCheckbox).checkbox("check")) : s ? (F.verbose("Setting checkbox value", n, a), a.checkbox(n === !0 ? "check" : "uncheck")) : c ? (F.verbose("Setting tajerdropdown value", n, a), a.tajerdropdown("set selected", n)) : (F.verbose("Setting field value", n, o), o.val(n)))
                        })
                    }
                }, validate: {
                    form: function (e, t) {
    ...
    "use strict";
    e.fn.tajeraccordion = function (n) {
        {
        ...
        return a.each(function () {
            var d, m, f = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.tajeraccordion.settings, n) : e.extend({}, e.fn.tajeraccordion.settings), g = f.className, p = f.namespace, v = f.selector, h = f.error, b = "." + p, y = "module-" + p, x = a.selector || "", C = e(this), w = C.find(v.title), k = C.find(v.content), S = this, T = C.data(y);
            m = {
                initialize: function () {
                    ...
                    m.debug("Toggling visibility of content", n), s || c ? f.collapsible ? m.close.call(n) : m.debug("Cannot close tajeraccordion content collapsing is disabled") : m.open.call(n)
                }, open: function (t) {
                    ...
                    return s ? void m.debug("Accordion already open, skipping", o) : (m.debug("Opening tajeraccordion content", n), f.onOpening.call(o), f.exclusive && m.closeOthers.call(n), n.addClass(g.active), o.stop(!0, !0).addClass(g.animating), f.animateChildren && (e.fn.transition !== i && C.transition("is supported") ? o.children().transition({
                        animation: "fade in",
                        queue: !1,
                        useFailSafe: !0,
                        debug: f.debug,
                    ...
                    var n = t !== i ? "number" == typeof t ? w.eq(t) : e(t).closest(v.title) : e(this).closest(v.title), o = n.next(k), a = o.hasClass(g.animating), r = o.hasClass(g.active), s = !r && a, c = r && a;
                    !r && !s || c || (m.debug("Closing tajeraccordion content", o), f.onClosing.call(o), n.removeClass(g.active), o.stop(!0, !0).addClass(g.animating), f.animateChildren && (e.fn.transition !== i && C.transition("is supported") ? o.children().transition({
                        animation: "fade out",
                        queue: !1,
                        useFailSafe: !0,
                        debug: f.debug,
                    ...
                    var n, o, a, r = t !== i ? w.eq(t) : e(this).closest(v.title), s = r.parents(v.content).prev(v.title), c = r.closest(v.tajeraccordion), l = v.title + "." + g.active + ":visible", u = v.content + "." + g.active + ":visible";
    ...
    }, e.fn.tajeraccordion.settings = {
        name: "Accordion",
        namespace: "tajeraccordion",
        debug: !1,
        verbose: !1,
        performance: !0,
        on: "click",
        ...
        selector: {tajeraccordion: ".tajeraccordion", title: ".title", trigger: ".title", content: ".content"}
    }, e.extend(e.easing, {
        ...
        return a.each(function () {
            ...
            m = {
                initialize: function () {
                    ...
                    C = x.children(v.label), w = x.children(v.input), k = w[0]
                }, hide: {
                    input: function () {
                    ...
                    "MutationObserver" in t && (a = new MutationObserver(function (e) {
                        m.debug("DOM tree modified, updating selector cache"), m.refresh()
                    }), a.observe(R, {childList: !0, subtree: !0}), m.debug("Setting up mutation observer", a))
                }, attachEvents: function (t, n) {
                    var i = e(t);
                    ...
                    click: function (t) {
                        var n = e(t.target);
                        return n.is(v.input) ? void m.verbose("Using default check action on initialized checkbox") : n.is(v.link) ? void m.debug("Clicking link inside checkbox, skipping toggle") : (m.toggle(), w.focus(), void t.preventDefault())
                    }, keydown: function (e) {
                        var t = e.which, n = {enter: 13, space: 32, escape: 27};
                        t == n.escape ? (m.verbose("Escape key pressed blurring field"), w.blur(), T = !0) : e.ctrlKey || t != n.space && t != n.enter ? T = !1 : (m.verbose("Enter/space key pressed, toggling checkbox"), m.toggle(), T = !0)
                    }, keyup: function (e) {
                        T && e.preventDefault()
                    }
                }, check: function () {
                    m.should.allowCheck() && (m.debug("Checking checkbox", w), m.set.checked(), m.should.ignoreCallbacks() || (f.onChecked.call(k), f.onChange.call(k)))
                }, uncheck: function () {
    ...
    e.fn.tajerdropdown = function (o) {
        ...
        return r.each(function (p) {
            var v, h, b, y, x, C, w, k = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.tajerdropdown.settings, o) : e.extend({}, e.fn.tajerdropdown.settings), S = k.className, T = k.message, A = k.fields, R = k.metadata, P = k.namespace, E = k.regExp, F = k.selector, D = k.error, O = k.templates, q = "." + P, j = "module-" + P, z = e(this), I = e(k.context), L = z.find(F.text), N = z.find(F.search), V = z.find(F.input), H = z.find(F.icon), M = z.prev().find(F.text).length > 0 ? z.prev().find(F.text) : z.prev(), U = z.children(F.menu), W = U.find(F.item), B = !1, Q = !1, X = !1, $ = this, Y = z.data(j);
            w = {
                initialize: function () {
                    w.debug("Initializing tajerdropdown", k), w.is.alreadySetup() ? w.setup.reference() : (w.setup.layout(), w.refreshData(), w.save.defaults(), w.restore.selected(), w.create.id(), w.bind.events(), w.observeChanges(), w.instantiate())
                }, instantiate: function () {
                    w.verbose("Storing instance of tajerdropdown", w), Y = w, z.data(j, w)
                }, destroy: function () {
                    w.verbose("Destroying previous tajerdropdown", z), w.remove.tabbable(), z.off(q).removeData(j), U.off(q), s.off(b), x && x.disconnect(), C && C.disconnect()
                }, observeChanges: function () {
                    ...
                    id: function () {
                        ...
                        return (t = t || w.get.userValues()) ? (t = e.isArray(t) ? t : [t], e.each(t, function (t, r) {
                            w.get.item(r) === !1 && (a = k.templates.addition(w.add.variables(T.addResult, r)), o = e("<div />").html(a).attr("data-" + R.value, r).attr("data-" + R.text, r).addClass(S.addition).addClass(S.item), n = n === i ? o : n.add(o), w.verbose("Creating user choices for value", r, o))
                        }), n) : !1
                    ...
                    firstUnfiltered: function () {
                        w.verbose("Selecting first non-filtered element"), w.remove.selectedItem(), W.not(F.unselectable).eq(0).addClass(S.selected)
                    }, nextAvailable: function (e) {
                        e = e.eq(0);
                        var t = e.nextAll(F.item).not(F.unselectable).eq(0), n = e.prevAll(F.item).not(F.unselectable).eq(0), i = t.length > 0;
                    ...
                    api: function () {
                        ...
                        w.verbose("First request, initializing API"), z.api(e)
                    }, layout: function () {
                        z.is("select") && (w.setup.select(), w.setup.returnedObject()), w.has.menu() || w.create.menu(), w.is.search() && !w.has.search() && (w.verbose("Adding search input"), N = e("<input />").addClass(S.search).insertBefore(L)), k.allowTab && w.set.tabbable()
                    }, select: function () {
                        var t = w.get.selectValues();
                        w.debug("Dropdown initialized on a select", t), z.is("select") && (V = z), V.parent(F.tajerdropdown).length > 0 ? (w.debug("UI tajerdropdown already exists. Creating tajerdropdown menu only"), z = V.closest(F.tajerdropdown), w.has.menu() || w.create.menu(), U = z.children(F.menu), w.setup.menu(t)) : (w.debug("Creating entire tajerdropdown from select"), z = e("<div />").attr("class", V.attr("class")).addClass(S.selection).addClass(S.tajerdropdown).html(O.tajerdropdown(t)).insertBefore(V), V.hasClass(S.multiple) && V.prop("multiple") === !1 && (w.error(D.missingMultiple), V.prop("multiple", !0)), V.is("[multiple]") && w.set.multiple(), V.prop("disabled") && (w.debug("Disabling tajerdropdown"), z.addClass(S.disabled)), V.removeAttr("class").detach().prependTo(z)), w.refresh()
                    }, menu: function (e) {
                        U.html(O.menu(e, A)), W = U.find(F.item)
                    }, reference: function () {
                        w.debug("Dropdown behavior was called on select, replacing with closest tajerdropdown"), z = z.parent(F.tajerdropdown), w.refresh(), w.setup.returnedObject(), f && (Y = w, w.invoke(m))
                    ...
                    w.verbose("Refreshing selector cache"), L = z.find(F.text), N = z.find(F.search), V = z.find(F.input), H = z.find(F.icon), M = z.prev().find(F.text).length > 0 ? z.prev().find(F.text) : z.prev(), U = z.children(F.menu), W = U.find(F.item)
                }, refreshData: function () {
                    w.verbose("Refreshing cached metadata"), W.removeData(R.text).removeData(R.value), z.removeData(R.defaultText).removeData(R.defaultValue).removeData(R.placeholderText)
                }, toggle: function () {
                    w.verbose("Toggling menu visibility"), w.is.active() ? w.hide() : w.show()
                }, show: function (t) {
                    if (t = e.isFunction(t) ? t : function () {
                        }, w.can.show() && !w.is.active()) {
                        if (w.debug("Showing tajerdropdown"), w.is.multiple() && !w.has.search() && w.is.allFiltered())return !0;
                        w.has.message() && !w.has.maxSelections() && w.remove.message(), k.onShow.call($) !== !1 && w.animate.show(function () {
                            w.can.click() && w.bind.intent(), w.set.visible(), t.call($)
                        })
                    }
                }, hide: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    }, w.is.active() && (w.debug("Hiding tajerdropdown"), k.onHide.call($) !== !1 && w.animate.hide(function () {
                        w.remove.visible(), t.call($)
                    }))
                }, hideOthers: function () {
                    w.verbose("Finding other tajerdropdowns to hide"), r.not(z).has(F.menu + "." + S.visible).tajerdropdown("hide")
                }, hideMenu: function () {
                    ...
                    var t = e !== i ? e : w.get.query(), n = function () {
                        w.is.multiple() && w.filterActive(), w.select.firstUnfiltered(), w.has.allResultsFiltered() ? k.onNoResults.call($, t) ? k.allowAdditions || (w.verbose("All items filtered, showing message", t), w.add.message(T.noResults)) : (w.verbose("All items filtered, hiding tajerdropdown", t), w.hideMenu()) : w.remove.message(), k.allowAdditions && w.add.userSuggestion(e), w.is.searchSelection() && w.can.show() && w.is.focusedOnSearch() && w.show()
                    };
                    ...
                    w.has.query() ? (w.verbose("Searching for matching values", n), W.each(function () {
                        var t, i, a = e(this);
                    ...
                    })) : o = W, w.debug("Showing only matched items", n), w.remove.filteredItem(), W.not(o).addClass(S.filtered)
                    ...
                    var e = W.not(S.filtered).filter("." + S.selected).eq(0), t = W.not(S.filtered).filter("." + S.active).eq(0), n = e.length > 0 ? e : t, i = n.size() > 0;
                    i && w.has.query() ? (w.debug("Forcing partial selection to selected item", n), w.event.item.click.call(n)) : w.hide()
                }, event: {
                    change: function () {
                        X || (w.debug("Input changed, updating selection"), w.set.selected())
                    }, focus: function () {
                        ...
                        h = n.activeElement === this, B || h || (w.remove.activeLabel(), w.hide())
                    }, mousedown: function () {
                        B = !0
                    }, mouseup: function () {
                        B = !1
                        ...
                        focus: function () {
                            ...
                            h = n.activeElement === this, Q || h ? h && k.forceSelection && w.forceSelection() : w.is.multiple() ? (w.remove.activeLabel(), w.hide()) : k.forceSelection ? w.forceSelection() : w.hide()
                        }
                    }, icon: {
                        click: function (e) {
                        ...
                        click: function (t) {
                            var n = e(this), i = z.find(F.label), o = i.filter("." + S.active), a = n.nextAll("." + S.active), r = n.prevAll("." + S.active), s = a.length > 0 ? n.nextUntil(a).add(o).add(n) : n.prevUntil(r).add(o).add(n);
                        ...
                        mouseenter: function (t) {
                            var n = e(this).children(F.menu), i = e(this).siblings(F.item).children(F.menu);
                            ...
                            var n = e(this), i = e(t ? t.target : ""), o = n.find(F.menu), a = w.get.choiceText(n), r = w.get.choiceValue(n, a), s = o.length > 0, c = o.find(i).length > 0;
                        ...
                        keydown: function (e) {
                            ...
                            if (i) {
                                var o = z.find(F.label), a = o.filter("." + S.active), r = (a.data(R.value), o.index(a)), s = o.length, c = a.length > 0, l = a.length > 1, u = 0 === r, d = r + 1 == s, m = w.is.searchSelection(), f = w.is.focusedOnSearch(), g = w.is.focused(), p = f && 0 === w.get.caretPosition();
                                if (m && !c && !f)return;
                        ...
                        if (i) {
                            ...
                            if (w.is.visible()) {
                                if ((t == n.enter || v) && (t == n.enter && g && f && !k.allowCategorySelection ? (w.verbose("Pressed enter on unselectable category, opening sub menu"), t = n.rightArrow) : p && (w.verbose("Selecting item from keyboard shortcut", c), w.event.item.click.call(c, e), w.is.searchSelection() && w.remove.searchTerm()), e.preventDefault()), t == n.leftArrow && (a = d[0] !== U[0], a && (w.verbose("Left key pressed, closing sub-menu"), w.animate.hide(!1, d), c.removeClass(S.selected), d.closest(F.item).addClass(S.selected), e.preventDefault())), t == n.rightArrow && f && (w.verbose("Right key pressed, opening sub-menu"), w.animate.show(!1, u), c.removeClass(S.selected), u.find(F.item).eq(0).addClass(S.selected), e.preventDefault()), t == n.upArrow) {
                                    if (o = g && m ? c.prevAll(F.item + ":not(" + F.unselectable + ")").eq(0) : W.eq(0), l.index(o) < 0)return w.verbose("Up key pressed but reached top of current menu"), void e.preventDefault();
                                ...
                                if (t == n.downArrow) {
                                    if (o = g && m ? o = c.nextAll(F.item + ":not(" + F.unselectable + ")").eq(0) : W.eq(0), 0 === o.length)return w.verbose("Down key pressed but reached bottom of current menu"), void e.preventDefault();
                                    w.verbose("Down key pressed, changing active item"), W.removeClass(S.selected), o.addClass(S.selected), w.set.scrollPosition(o), e.preventDefault()
                                }
                                t == n.pageUp && (w.scrollPage("up"), e.preventDefault()), t == n.pageDown && (w.scrollPage("down"), e.preventDefault()), t == n.escape && (w.verbose("Escape key pressed, closing tajerdropdown"), w.hide())
                            } else v && e.preventDefault(), t == n.downArrow && (w.verbose("Down key pressed, showing tajerdropdown"), w.show(), e.preventDefault())
                        } else w.is.selection() && !w.is.search() && w.set.selectedLetter(String.fromCharCode(t))
                    }
                }, determine: {
                    selectAction: function (t, n) {
                        w.verbose("Determining action", k.action), e.isFunction(w.action[k.action]) ? (w.verbose("Triggering preset action", k.action, t, n), w.action[k.action].call(this, t, n)) : e.isFunction(k.action) ? (w.verbose("Triggering user action", k.action, t, n), k.action.call(this, t, n)) : w.error(D.action, k.action)
                    }, eventInModule: function (t, i) {
                        var o = e(t.target), a = o.closest(n.documentElement).length > 0, r = o.closest(z).length > 0;
                        return i = e.isFunction(i) ? i : function () {
                        }, a && !r ? (w.verbose("Triggering event", i), i(), !0) : (w.verbose("Event occurred in tajerdropdown, canceling callback"), !1)
                    }, eventOnElement: function (t, n) {
                        var i = e(t.target), o = i.closest(F.siblingLabel), a = 0 === z.find(o).length, r = 0 === i.closest(U).length;
                        return n = e.isFunction(n) ? n : function () {
                        }, a && r ? (w.verbose("Triggering event", n), n(), !0) : (w.verbose("Event occurred in tajerdropdown menu, canceling callback"), !1)
                    }
                }, action: {
                    nothing: function () {
                    ...
                    id: function () {
                        ...
                        return n = n !== i ? n : k.preserveHTML, t ? (t.find(F.menu).length > 0 && (w.verbose("Retreiving text of element with sub-menu"), t = t.clone(), t.find(F.menu).remove(), t.find(F.menuIcon).remove()), t.data(R.text) !== i ? t.data(R.text) : e.trim(n ? t.html() : t.text())) : void 0
                    }, choiceValue: function (t, n) {
                        return n = n || w.get.choiceText(t), t ? t.data(R.value) !== i ? String(t.data(R.value)) : "string" == typeof n ? e.trim(n.toLowerCase()) : String(n) : !1
                    }, inputEvent: function () {
                        var e = N[0];
                        ...
                        return t = t !== i ? t : w.get.values() !== i ? w.get.values() : w.get.text(), o = a ? t.length > 0 : t !== i && null !== t, a = w.is.multiple() && e.isArray(t), n = "" === t || 0 === t ? !0 : n || !1, o && W.each(function () {
                            ...
                            if (null !== c && c !== i)if (a)(-1 !== e.inArray(String(c), t) || -1 !== e.inArray(s, t)) && (r = r ? r.add(o) : o); else if (n) {
                                if (w.verbose("Ambiguous tajerdropdown value using strict type check", o, t), c === t || s === t)return r = o, !0
                            } else if (String(c) == String(t) || s == t)return w.verbose("Found select item by value", c, t), r = o, !0
                        }), r
                    }
                }, check: {
                    maxSelections: function (e) {
                        return k.maxSelections ? (e = e !== i ? e : w.get.selectionCount(), e >= k.maxSelections ? (w.debug("Maximum selection count reached"), k.useLabels && (W.addClass(S.filtered), w.add.message(T.maxSelections)), !0) : (w.verbose("No longer at maximum selection count"), w.remove.message(), w.remove.filteredItem(), w.is.searchSelection() && w.filterItems(), !1)) : !0
                    }
                }, restore: {
                    defaults: function () {
                    ...
                    remoteData: function (e) {
                        var n;
                        return t.Storage === i ? void w.error(D.noStorage) : (n = sessionStorage.getItem(e), n !== i ? n : !1)
                    }
                }, save: {
                    defaults: function () {
                        ...
                        var e = w.get.value();
                        w.verbose("Saving default value as", e), z.data(R.defaultValue, e)
                    }, defaultText: function () {
                        var e = w.get.text();
                        w.verbose("Saving default text as", e), z.data(R.defaultText, e)
                    }, placeholderText: function () {
                        var e;
                        k.placeholder !== !1 && L.hasClass(S.placeholder) && (e = w.get.text(), w.verbose("Saving placeholder text as", e), z.data(R.placeholderText, e))
                    }, remoteData: function (e, n) {
                        return t.Storage === i ? void w.error(D.noStorage) : (w.verbose("Saving remote data to session storage", n, e), void sessionStorage.setItem(n, e))
                    }
                }, clear: function () {
                    ...
                    var n, i, o, a = t || w.get.selectedItem(), r = a.closest(F.menu), s = r.outerHeight(), c = r.scrollTop(), l = W.eq(0).outerHeight(), u = Math.floor(s / l), d = (r.prop("scrollHeight"), "up" == e ? c - l * u : c + l * u), m = W.not(F.unselectable);
                    ...
                    filtered: function () {
                        ...
                        e && o && (w.verbose("Adjusting input width", a, k.glyphWidth), N.css("width", a)), o || n && r ? (w.verbose("Hiding placeholder text"), L.addClass(S.filtered)) : (!e || n && !r) && (w.verbose("Showing placeholder text"), L.removeClass(S.filtered))
                    }, loading: function () {
                        ...
                        w.has.search() ? (w.debug("Added tabindex to searchable tajerdropdown"), N.val("").attr("tabindex", 0), U.attr("tabindex", -1)) : (w.debug("Added tabindex to tajerdropdown"), z.attr("tabindex") || (z.attr("tabindex", 0), U.attr("tabindex", -1)))
                    }, initialLoad: function () {
                        ...
                        e = e || w.get.selectedItem(), n = e.closest(F.menu), o = e && e.length > 0, t = t !== i ? t : !1, e && n.length > 0 && o && (r = e.position().top, n.addClass(S.loading), c = n.scrollTop(), s = n.offset().top, r = e.offset().top, a = c - s + r, t || (l = n.height(), d = a + m > c + l, u = c > a - m), w.debug("Scrolling to active item", a), (t || u || d) && n.scrollTop(a), n.removeClass(S.loading))
                    }, text: function (e) {
                        "select" !== k.action && ("combo" == k.action ? (w.debug("Changing combo button text", e, M), k.preserveHTML ? M.html(e) : M.text(e)) : (e !== w.get.placeholderText() && L.removeClass(S.placeholder), w.debug("Changing text", e, L), L.removeClass(S.filtered), k.preserveHTML ? L.html(e) : L.text(e)))
                        ...
                        var o = V.length > 0, a = (!w.has.value(e), w.get.values()), r = e !== i ? String(e) : e;
                        if (o) {
                            if (r == a && (w.verbose("Skipping value update already same value", e, a), !w.is.initialLoad()))return;
                            w.is.single() && w.has.selectInput() && w.can.extendSelect() && (w.debug("Adding user option", e), w.add.optionValue(e)), w.debug("Updating input value", e, a), X = !0, V.val(e), k.fireOnInit === !1 && w.is.initialLoad() ? w.debug("Input native change event ignored on initial load") : V.trigger("change"), X = !1
                        } else w.verbose("Storing value in metadata", e, V), e !== a && z.data(R.value, r);
                    ...
                    label: function (t, n, i) {
                        ...
                        var n = U.children(F.message), i = k.templates.message(w.add.variables(t));
                        n.length > 0 ? n.html(i) : n = e("<div/>").html(i).addClass(S.message).appendTo(U)
                    }, optionValue: function (t) {
                        var n = V.find('option[value="' + t + '"]'), i = n.length > 0;
                        i || (x && (x.disconnect(), w.verbose("Temporarily disconnecting mutation observer", t)), w.is.single() && (w.verbose("Removing previous user addition"), V.find("option." + S.addition).remove()), e("<option/>").prop("value", t).addClass(S.addition).html(t).appendTo(V), w.verbose("Adding user addition as an <option>", t), x && x.observe(V[0], {
                            childList: !0,
                            subtree: !0
                        }))
                        ...
                        if (!k.useLabels || !w.has.maxSelections()) {
                            ...
                            W.removeClass(S.selected), a ? (t = k.templates.addition(w.add.variables(T.addResult, e)), n.html(t).attr("data-" + R.value, e).attr("data-" + R.text, e).removeClass(S.filtered).addClass(S.selected), w.verbose("Replacing user suggestion with new value", n)) : (n = w.create.userChoice(e), n.prependTo(U).addClass(S.selected), w.verbose("Adding item choice to menu corresponding with user choice addition", n))
                        }
                    ...
                    active: function () {
                        ...
                        var t = V.find('option[value="' + e + '"]'), n = t.length > 0;
                        n && t.hasClass(S.addition) && (x && (x.disconnect(), w.verbose("Temporarily disconnecting mutation observer", e)), t.remove(), w.verbose("Removing user addition as an <option>", e), x && x.observe(V[0], {
                            childList: !0,
                            subtree: !0
                        }))
                    }, message: function () {
                        ...
                        w.has.selectInput() ? (w.verbose("Input is <select> removing selected option", e), i = w.remove.arrayValue(e, o), w.remove.optionValue(e)) : (w.verbose("Removing from delimited values", e), i = w.remove.arrayValue(e, o), i = i.join(k.delimiter)), k.fireOnInit === !1 && w.is.initialLoad() ? w.verbose("No callback on initial load", k.onRemove) : k.onRemove.call($, e, t, n), w.set.value(i, t, n), w.check.maxSelections()
                    }, arrayValue: function (t, n) {
                        return e.isArray(n) || (n = [n]), n = e.grep(n, function (e) {
                            return t != e
                        }), w.verbose("Removed value from delimited string", t, n), n
                    }, label: function (e, t) {
                        var n = z.find(F.label), i = n.filter('[data-value="' + e + '"]');
                        w.verbose("Removing label", i), i.remove()
                    }, activeLabels: function (e) {
                        e = e || z.find(F.label).filter("." + S.active), w.verbose("Removing active label selections", e), w.remove.labels(e)
                    }, labels: function (t) {
                        t = t || z.find(F.label), w.verbose("Removing labels", t), t.each(function () {
                            var t = e(this).data(R.value), n = t !== i ? String(t) : t, o = w.is.userValue(n);
                            o ? (w.remove.value(n), w.remove.label(n)) : w.remove.selected(n)
                        })
                    }, tabbable: function () {
                        w.has.search() ? (w.debug("Searchable tajerdropdown initialized"), N.attr("tabindex", "-1"), U.attr("tabindex", "-1")) : (w.debug("Simple selection tajerdropdown initialized"), z.attr("tabindex", "-1"), U.attr("tabindex", "-1"))
                    }
                }, has: {
                    search: function () {
                        return N.length > 0
                    ...
                    active: function () {
                        ...
                        return z.is("select") && z.parent(F.tajerdropdown).length > 0 && 0 === z.prev().length
                        ...
                        return n.addClass(S.loading), t = {
                            context: {scrollTop: I.scrollTop(), height: I.outerHeight()},
                        ...
                        return w.has.search() && 1 === N.parent(F.tajerdropdown).length
                    }, selection: function () {
                    ...
                    show: function (t, n) {
                        ...
                        t = e.isFunction(t) ? t : function () {
                        }, w.verbose("Doing menu show animation", a), w.set.direction(n), o = w.get.transition(n), w.is.selection() && w.set.scrollPosition(w.get.selectedItem(), !0), (w.is.hidden(a) || w.is.animating(a)) && ("none" == o ? (r(), a.transition("show"), t.call($)) : e.fn.transition !== i && z.transition("is supported") ? a.transition({
                            animation: o + " in",
                            debug: k.debug,
                            verbose: k.verbose,
                            duration: k.duration,
                        ...
                        t = e.isFunction(t) ? t : function () {
                        }, (w.is.visible(o) || w.is.animating(o)) && (w.verbose("Doing menu hide animation", o), "none" == r ? (a(), o.transition("hide"), t.call($)) : e.fn.transition !== i && z.transition("is supported") ? o.transition({
                            animation: r + " out",
                            duration: k.duration,
                            debug: k.debug,
                            verbose: k.verbose,
                            ...
                            onStart: a,
                            onComplete: function () {
                                "auto" == k.direction && w.remove.upward(n), t.call($)
                            }
                    ...
                    return n = n || g, o = $ || o, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
                        ...
                        if (e.isPlainObject(l[a]) && n != r)l = l[a]; else {
                            if (l[a] !== i)return s = l[a], !1;
                            if (!e.isPlainObject(l[o]) || n == r)return l[o] !== i ? (s = l[o], !1) : (w.error(D.method, t), !1);
                            l = l[o]
                        }
        ...
        error: {
            action: "You called a tajerdropdown action that was not defined",
            alreadySetup: "Once a select has been initialized behaviors must be called on the created ui tajerdropdown",
    ...
    }, e.fn.tajerdropdown.settings.templates = {
        tajerdropdown: function (t) {
    ...
    e.fn.suimodal = function (o) {
        ...
        return r.each(function () {
            var r, h, b, y, x, C, w, k, S, T = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.suimodal.settings, o) : e.extend({}, e.fn.suimodal.settings), A = T.selector, R = T.className, P = T.namespace, E = T.error, F = "." + P, D = "module-" + P, O = e(this), q = e(T.context), j = O.find(A.close), z = this, I = O.data(D);
            S = {
                initialize: function () {
                    ...
                    S.verbose("Storing instance of suimodal"), I = S, O.data(D, I)
                }, create: {
                    dimmer: function () {
                        var t = {
                            debug: T.debug,
                    ...
                    S.verbose("Destroying previous suimodal"), O.removeData(D).off(F), s.off(C), j.off(F), q.dimmer("destroy")
                }, observeChanges: function () {
                    ...
                    h = O.siblings(A.suimodal), r = h.add(O)
                }, attachEvents: function (t, n) {
                    var i = e(t);
                    n = e.isFunction(S[n]) ? S[n] : S.toggle, i.length > 0 ? (S.debug("Attaching suimodal events to element", t, n), i.off(F).on("click" + F, n)) : S.error(E.notFound, t)
                }, bind: {
                    events: function () {
                    ...
                    approve: function () {
                        ...
                        var i = e(t.target), o = i.closest(A.suimodal).length > 0, a = e.contains(n.documentElement, t.target);
                        ...
                        var t = e.which, n = 27;
                        t == n && (T.closable ? (S.debug("Escape key pressed hiding suimodal"), S.hide()) : S.debug("Escape key pressed, but closable is set to false"), e.preventDefault())
                    }, resize: function () {
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, S.is.animating() || !S.is.active() ? (S.showDimmer(), S.cacheSizes(), S.set.position(), S.set.screenHeight(), S.set.type(), S.set.clickaway(), !T.allowMultiple && S.others.active() ? S.hideOthers(S.showModal) : (T.onShow.call(z), T.transition && e.fn.transition !== i && O.transition("is supported") ? (S.debug("Showing suimodal with css animations"), O.transition({
                        debug: T.debug,
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, S.debug("Hiding suimodal"), T.onHide.call(z), (S.is.animating() || S.is.active()) && (T.transition && e.fn.transition !== i && O.transition("is supported") ? (S.remove.active(), O.transition({
                        debug: T.debug,
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, n.length > 0 && (S.debug("Hiding all visible modals"), S.hideDimmer(), n.suimodal("hide suimodal", t))
                }, hideOthers: function (t) {
                    var n = h.filter("." + R.active + ", ." + R.animating);
                    t = e.isFunction(t) ? t : function () {
                    }, n.length > 0 && (S.debug("Hiding other modals", h), n.suimodal("hide suimodal", t, !0))
                }, others: {
                    active: function () {
                    ...
                    }), S.debug("Caching suimodal and container sizes", S.cache)
                }, can: {
                    fit: function () {
                    ...
                    autofocus: function () {
                        ...
                        S.verbose("Centering suimodal on page", S.cache), O.css(S.can.fit() ? {
                            top: "",
        ...
        return r.each(function () {
            ...
            y = {
                initialize: function () {
                    ...
                    if (e = e || function () {
                            }, y.debug("Showing pop-up", x.transition), y.is.hidden() && (!y.is.active() || !y.is.tajerdropdown())) {
                    ...
                    show: function (t) {
                        ...
                        }, y.debug("Hiding pop-up"), x.onHide.call(n, j) === !1 ? void y.debug("onHide callback returned false, cancelling popup animation") : void(x.transition && e.fn.transition !== i && P.transition("is supported") ? n.transition({
                    ...
                    }, tajerdropdown: function () {
                        return P.hasClass(w.tajerdropdown)
                    }, hidden: function () {
                        return !y.is.visible()
                    }, rtl: function () {
        ...
        return e(this).each(function () {
            ...
            f = {
                initialize: function () {
                    ...
                    if (r == s.escape && (f.verbose("Escape key pressed, blurring search field"), T.trigger("blur")), f.is.visible())if (r == s.enter) {
        ...
        return r.each(function () {
            ...
            w = {
                initialize: function () {
                    ...
                    w.verbose("Destroying previous module for", D), D.off(E).removeData(F), w.is.ios() && w.remove.ios(), O.off(b), s.off(b), c.off(b)
                }, event: {
                    ...
                    clickaway: function () {
                        ...
                        k.scrollLock && (w.debug("Disabling page scroll"), s.on("DOMMouseScroll" + b, w.event.scroll)), w.verbose("Adding events to contain sidebar scroll"), c.on("touchmove" + b, w.event.touch), D.on("scroll" + E, w.event.containScroll)
                    }
                }, unbind: {
                    clickaway: function () {
                        w.verbose("Removing clickaway events from context", O), O.off(b)
                    }, scrollLock: function () {
                        w.verbose("Removing scroll lock from page"), c.off(b), s.off(b), D.off("scroll" + E)
                    }
                }, add: {
                    inlineCSS: function () {
